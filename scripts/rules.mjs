...
export const TIPS = {
  lounge: {basic: {head: "Fixers, +2 to:", plus: "+2", list: ["Bribery", "Bureaucracy", "Business", "Conversation", "Human Perception", "Persuasion", "Trading"], cond: "In meetings held at the HQ."},
  ...
  medbay: {basic: {head: "Crew heals BODY +2 per day of rest. Medtechs, +2 to:", plus: "+2", list: ["First Aid", "Paramedic", "Surgery"], cond: "Skills only while at the HQ."},
    up: {head: "Medtechs cook street drugs", cond: "Upgrade, fabricate and invent them with Science (Chemistry), as a Tech would. Their Medical Tech counts as the expertise."}},
  studio: {basic: {head: "Rockerboys, +2 to:", plus: "+2", list: ["Acting", "Composition", "Play Instrument", "Paint/Draw/Sculpt", "Photography/Film"], cond: "While at the HQ."},
    up: {head: "Rockerboys refine a project for +2", cond: "A week of downtime adds +2 to that project's art checks; a failed week stacks another +2. Ends when the project is done, dropped, or a natural 1 is rolled."}},
  evidence: {basic: {head: "Lawmen and Medias, +2 to:", plus: "+2", list: ["Composition", "Criminology", "Cryptography", "Deduction", "Education", "Forgery", "Library Search", "Photography/Film"], cond: "For ongoing investigations, at the HQ."},
  ...
  training: {basic: {head: "Anyone, +1 to one of:", plus: "+1", list: ["Athletics", "Archery", "Autofire", "Brawling", "Evasion", "Handgun", "Heavy Weapons", "Martial Arts", "Melee Weapon", "Shoulder Arms"], cond: "A week of practice. Lasts until the crew's next HQ IP award, or until they practice again."},
    up: {head: "Solos practice two skills at once"}},
  morale: {basic: {head: "Whole crew: −50eb Lifestyle each, every month"},
    ladder: ["Restore 1d6/2 Humanity each month", "Heal as if BODY were 1 higher", "Crew gains 1 LUCK", "Monthly Humanity becomes 1d6", "Fixers +2 Trading on pay; others haggle 20% more", "Hustle twice, keep the better", "Another 1 LUCK", "Hustle twice, keep both", "Monthly Humanity: best of 2d6", "A unique benefit agreed with the GM"]},
  ...
  lockup: {basic: {head: "One soundproof cell", cond: "A prisoner needs BODY 13 to break out."}, up: {head: "Three cells; Lawmen +2 Interrogation", cond: "Against a prisoner held at least a day."}},
  server: {basic: {head: "The HQ's own NET Architecture", cond: "Built with 20,000eb of Home Security 2045. Nothing bought with it can be resold or removed; unspent funds are lost."},
    up: {head: "Netrunners craft decks, hardware and programs", cond: "Upgrade, fabricate and invent with Electronics/Security Tech, as a Tech would. Their Interface rank counts as the expertise."}},
  workshop: {basic: {head: "Techs bank the same hours toward a second project", cond: "Upgrade, Fabrication or Invention work done at the HQ."}, up: {head: "A third project"}},
